...
export class Backend implements backendInterface {
    ...
    async deleteSubmission(arg0: Time): Promise<void> {
    ...
    async getUnreadSubmissions(): Promise<Array<ContactSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUnreadSubmissions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markAsRead(arg0: Time): Promise<void> {
        if (this.processError) {
            try {
